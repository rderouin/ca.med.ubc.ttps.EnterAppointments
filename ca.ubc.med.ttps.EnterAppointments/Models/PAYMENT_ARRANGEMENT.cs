...
namespace ca.ubc.med.ttps.EnterAppointments.Models
{
    ...
    public partial class PAYMENT_ARRANGEMENT
    {
        public PAYMENT_ARRANGEMENT()
        {
            this.People = new HashSet<PERSON>();
        }
    
        public int PAYMENT_ARRANGEMENT_ID { get; set; }
        public string PAYMENT_ARRANGEMENT_DESC { get; set; }
