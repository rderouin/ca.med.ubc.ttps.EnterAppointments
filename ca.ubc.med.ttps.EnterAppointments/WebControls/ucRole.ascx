...
<table style="width:100%">
    ...
    <tr>
        <td colspan="3" style="text-align:center;">
            <asp:Button ID="btnSave" runat="server" Text="Save" Width="60px"  CssClass="ButtonRoundedCorners" />&nbsp;<asp:Button ID="btnContinueToPayee" runat="server" Enabled="false" Text="Continue" Width="60px"  CssClass="ButtonRoundedCorners" />
        </td>
    </tr>
</table>